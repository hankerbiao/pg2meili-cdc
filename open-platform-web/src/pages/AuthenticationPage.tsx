  ...
  return (
    <DocsLayout toc={[{ href: '#header', label: '请求头' }, { href: '#scopes', label: '权限范围' }, { href: '#errors', label: '错误响应' }, { href: '#security', label: '安全建议' }]}>
      <article className="doc-article">
        ...
        <section id="errors"><h2>错误响应</h2><table className="docs-table"><thead><tr><th>状态码</th><th>错误码</th><th>含义</th></tr></thead><tbody><tr><td>401</td><td><code>INVALID_API_KEY</code></td><td>Key 无效、过期、撤销或应用已禁用</td></tr><tr><td>403</td><td><code>INSUFFICIENT_SCOPE</code></td><td>Key 缺少当前操作所需权限</td></tr><tr><td>409</td><td><code>APP_DELETING</code></td><td>应用正在删除或已删除，数据面请求被拒绝</td></tr><tr><td>503</td><td><code>AUTH_UNAVAILABLE</code></td><td>区域鉴权缓存暂时不可用</td></tr></tbody></table></section>
